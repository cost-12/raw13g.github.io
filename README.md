...
- **Lock de Execução de Dupla Camada ([jb.js](file:///c:/Users/Thiago%20Silva%20Costa/raw13g.github.io/jb.js) e [jb.html](file:///c:/Users/Thiago%20Silva%20Costa/raw13g.github.io/jb.html))**:
  ...
  - Heartbeat periódico (15s) apenas para diagnóstico. Locks `running` não expiram automaticamente, pois liberar um lock durante uma cadeia ainda ativa poderia permitir uma segunda execução e causar corrupção concorrente do kernel.
